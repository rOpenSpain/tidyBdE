...
- Now
  [`?bde_indicators`](https://ropenspain.github.io/tidyBdE/dev/reference/bde_indicators.md)
...
- [`bde_vivid_pal()`](https://ropenspain.github.io/tidyBdE/dev/reference/bde_pals.md)
  and
  [`bde_rose_pal()`](https://ropenspain.github.io/tidyBdE/dev/reference/bde_pals.md)
  ...
  instead.
- [`scale_color_bde_d()`](https://ropenspain.github.io/tidyBdE/dev/reference/scales_bde.md)
  and friends now leverage
  [`bde_tidy_palettes()`](https://ropenspain.github.io/tidyBdE/dev/reference/bde_tidy_palettes.md),
  and these functions gain two new arguments: `alpha` and `rev`.
...
- On indicators:
  - [`bde_ind_ibex()`](https://ropenspain.github.io/tidyBdE/dev/reference/bde_indicators.md)
    renamed to
...
- Export
  [`bde_check_access()`](https://ropenspain.github.io/tidyBdE/dev/reference/bde_check_access.md).
