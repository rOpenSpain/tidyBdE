...
<img src="palettes-1.png" title="plot of chunk palettes" alt="plot of chunk palettes" width="100%" />

```r
scales::show_col(bde_vivid_pal()(6))
```

<img src="palettes-2.png" title="plot of chunk palettes" alt="plot of chunk palettes" width="100%" />
