...
description: Main Spanish economic indicators up to date.
date: "`r Sys.Date()`"
knitr:
  opts_chunk:
    collapse: true
...
This article shows the evolution of selected Spanish economic indicators using
data from [Banco de España](https://www.bde.es/).
