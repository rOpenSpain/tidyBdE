...
This article shows selected Spanish economic indicators using data from Banco de
España.
...
# Calculate rolling sum for the last four quarters
...
# Calculate rolling sum and join with population data
