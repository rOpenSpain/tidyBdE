...
title: "Series index"
date: "`r Sys.Date()`"
description: Summary of time series available through tidyBdE catalog metadata.
toc: true
...
Use the sequential number (`Numero_secuencial`) to load a time series from bulk
CSV files, as shown in the example. Use `Nombre_de_la_serie` as the API series
code for the Statistics web service (API) helpers.
