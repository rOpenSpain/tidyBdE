...
The basic entry point for searching time series is the time series catalog
(index). You can search for any series by name:
...
institution is working on an English version. Search terms must be provided in
...
relevant macroeconomic series, eliminating the need to search manually:
