...
#> $ tendencia        <chr> "+", "+", "-"
#> $ fechaValor       <date> 2026-07-03, 2026-07-03, 2026-07-03
#> $ valor            <dbl> 1.1448, 184.4800, 0.9190
...
#> Rows: 262
#> Columns: 2
#> $ Date            <date> 2026-07-03, 2026-07-02, 2026-07-01, 2026-06-30, 2026-…
#> $ DTCCBCEUSDEUR.B <dbl> 1.1448, 1.1399, 1.1383, 1.1394, 1.1406, 1.1401, 1.1342…
...
#> $ Decimals                 <chr> "4"
#> $ `Number of observations` <chr> "7.175"
#> $ `First value`            <chr> "[04/01/1999] 1.1448 USD"
#> $ `Last value`             <chr> "[03/07/2026] 1.1448 USD"
