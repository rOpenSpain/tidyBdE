...
#> $ tendencia        <chr> "-", "+", "+"
#> $ fechaValor       <date> 2026-07-01, 2026-07-01, 2026-07-01
#> $ valor            <dbl> 1.1383, 185.2100, 0.9234
...
#> Rows: 262
#> Columns: 2
#> $ Date            <date> 2026-07-01, 2026-06-30, 2026-06-29, 2026-06-26, 2026-…
#> $ DTCCBCEUSDEUR.B <dbl> 1.1383, 1.1394, 1.1406, 1.1401, 1.1342, 1.1340, 1.1392…
...
#> $ Decimals                 <chr> "4"
#> $ `Number of observations` <chr> "7.173"
#> $ `First value`            <chr> "[04/01/1999] 1.1383 USD"
#> $ `Last value`             <chr> "[01/07/2026] 1.1383 USD"
