# Contributing to tidyBdE

This guide explains how to propose a change to **tidyBdE**. Review the
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("rOpenSpain/tidyBdE", fork = TRUE)`.
...
Please note that the **tidyBdE** project is released with a [Contributor
Code of
Conduct](https://ropenspain.github.io/tidyBdE/CODE_OF_CONDUCT.md). By
