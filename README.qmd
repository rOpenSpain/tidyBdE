...
After you have found a series, you can load the GBP/EUR exchange rate using the
...
The package also provides several shortcut functions for a selection of relevant
...
Three custom palettes, based on those used by BdE in some publications, are
available.
...
You can use **tidyBdE** to create a local cache repository in a directory by
