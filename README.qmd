...
terms must be provided in Spanish to retrieve results. The institution is
working on an English version.

Once you have found a series, you can load the GBP/EUR exchange rate using the
...
series, so you do not need to search for them in advance:
