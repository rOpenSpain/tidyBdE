...
package infers date, character and numeric column types where possible. Bulk
CSV helpers identify series with stable sequential numbers
...
options(bde_cache_dir = "./.readme_cache")
```
...
Three custom palettes based on colors used by BdE in selected publications are
available.
